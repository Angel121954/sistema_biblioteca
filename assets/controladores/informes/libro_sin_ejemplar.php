...
$pdf->Cell(0, 10, utf8_decode('Informe de Libros Sin Ejemplares'), 0, 1, 'C');
$pdf->Ln(5);
...
$pdf->Cell(56, 8, 'Autor', 1, 0, 'C', true);
$pdf->Cell(28, 8, 'ISBN', 1, 0, 'C', true);
$pdf->Cell(34, 8, 'Categoria', 1, 1, 'C', true);
...
$pdf->Output('I', 'informe_libros_sin_ejemplares.pdf');
