...
$libros_result = $sql->efectuarConsulta("SELECT p.id_prestamo, l.titulo_libro, l.autor_libro,
                                ...
                                l.isbn_libro, c.nombre_categoria, l.disponibilidad_libro ORDER BY total_prestado DESC");

$pdf = new FPDF();
$pdf->AddPage();
$pdf->SetFont('Arial', 'B', 16);

$pdf->Cell(0, 10, utf8_decode('Informe de Libros Mas Prestados'), 0, 1, 'C');
$pdf->Ln(5);
...
$pdf->Output('I', 'informe_libros_mas_prestados.pdf');
